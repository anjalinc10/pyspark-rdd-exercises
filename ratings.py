...
sc = SparkContext("local[*]", "join_operations")
ratings_rdd = sc.textFile("C:\\Users\\hp\\Desktop\\week10\\ratings.dat")
...
movies_rdd = sc.textFile("C:\\Users\\hp\\Desktop\\week10\\movies.dat")
